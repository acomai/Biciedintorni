		...
		if($_POST["password"] != "")
		{
			if($_POST["password"] == $_POST["password2"])
			{
				...
				else
				{
					...
					echo "La password può contenere solo numeri e lettere e deve essere di minimo 8 caratteri.";
				}
			}
			else
			{
...
?>
<center>Se inserisci l'indirizzo email ti verrà spedita una mail con il tuo username e la tua password modificata.</center>
