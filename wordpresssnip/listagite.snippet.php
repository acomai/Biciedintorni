...
if($_GET['limit'] == '0')
	...
	$snipdb->query("SELECT *,UNIX_TIMESTAMP(dataeora) as 'data' FROM Sql145958_1.gite WHERE DATE(dataeora) >= CURDATE() AND approvata = 1 ORDER BY dataeora LIMIT 0,10 ;");
?>
...
<table>
	<tbody>
		<tr>
			...
			<th class="medie">Difficolt&agrave;</th>
		</tr>
		<?php 
