...
<html lang="it">
	<head>
		...
		<title>Bici e Dintorni - Anagrafiche dei soci dell'anno 2019</title>
	...
	<body>
		<div class="container-fluid">
			<header>
				<h1>Elenco soci dell'anno 2019</h1>
			</header>
...
$sql = "SELECT id, nome, cognome FROM anagrafiche WHERE a2019 = '1' ORDER BY cognome, nome;" ;
